...
"""
Launch file for displaying Inspire RH56 Hand with Foxglove Studio visualization.
...
Usage:
  ros2 launch inspire_rh56_hand_description display_foxglove.launch.py hand_side:=left
...
def launch_setup(context, *args, **kwargs):
    ...
    package_name = 'inspire_rh56_hand_description'
    ...
    if hand_side_value == 'left':
        xacro_file = os.path.join(pkg_share, 'urdf', 'inspire_hand_left.urdf.xacro')
    else:
        xacro_file = os.path.join(pkg_share, 'urdf', 'inspire_hand_right.urdf.xacro')
...
def generate_launch_description() -> LaunchDescription:
    """Generate launch description for Inspire RH56 Hand with Foxglove visualization."""
    # Declare arguments
